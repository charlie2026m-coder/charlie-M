...
const FAQSection = () => {
  ...
  return (
    <div className='w-full grid grid-cols-2 container px-[100px] py-[85px] gap-12 '>
      <div className='col-span-1 flex flex-col'>
        <h2 className='text-6xl font-bold jakarta leading-[1.2] mb-8'>Frequently Asked Questions</h2>
        <Image src='/images/street-1.png' alt='faq' width={576} height={430} className='w-[576px] h-[430px] rounded-[40px]' />
      </div>
      <div className='col-span-1 flex flex-col justify-between'>
        <div className='flex justify-between mb-10'>
          <Button className='flex w-[30%] items-center gap-2 text-white'><FaLocationDot size={24} />Check-in</Button>
          <Button variant='outline' className='flex w-[30%] items-center gap-2 text-brown'><AiOutlineLike size={24} />Amenities</Button>
          <Button variant='outline' className='flex w-[30%] items-center gap-2 text-brown'><FaSquareParking size={24}  />Parking</Button>
        </div>
