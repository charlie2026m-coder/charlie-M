...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        " w-full rounded-[20px] group/calendar [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative  font-semibold text-[15px]",
        ...
        outside: cn(
          "text-blue aria-selected:text-blue",
          defaultClassNames.outside
        ),
        disabled: cn(
          "!bg-gray-200 !text-gray-200 !opacity-100 cursor-not-allowed",
