...
function Checkbox({
  ...
  return (
    ...
    >
      ...
      >
        <CheckIcon className={cn("size-5", size === 'sm' ? 'size-2' : size === 'lg' ? 'size-6' : 'size-5')} />
      </CheckboxPrimitive.Indicator>
    </CheckboxPrimitive.Root>
  )
}
